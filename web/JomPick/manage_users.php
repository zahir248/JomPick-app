...
// Fetch user data from the database where role_id is equal to 2
$sql_user = "SELECT * FROM user WHERE role_id = 2 || role_id = 3";
...
<body>
    ...
    <div class="container mt-4">
        ...
        <a href="#addUserModal" class="btn btn-primary btn-sm" data-toggle="modal"><i class="fas fa-user-plus"></i> Add</a>
        </div>
        </div>
        <div class="row">
            <div >
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title text-center" id="addUserModalLabel">Add User</h5>
            ...
            <form method="post" action="add_user.php">
               ...
               <div class="form-check">
                    <input type="radio" class="form-check-input" id="staff" name="role" value="2" checked>
                    <label class="form-check-label" for="staff">Staff</label>
               </div>
               <div class="form-check">
                     <input type="radio" class="form-check-input" id="client" name="role" value="3">
